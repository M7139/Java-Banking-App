...
public class AddCustomerTest {
    ...
    public final void whenAddingCustomerWithOnlyCheckingThenOnlyCheckingPresent() {
        Customer customer = addCustomer.addNewCustomer("10001", "Saad", "Iqbal", "pass123", true, false, "PLATINUM");
    ...
    public final void whenAddingCustomerWithOnlySavingsThenOnlySavingsPresent() {
        Customer customer = addCustomer.addNewCustomer("10002", "Saad", "Khan", "pass123", false, true, "TITANIUM");
    ...
    public final void whenAddingCustomerWithBothThenBothPresent() {
        Customer customer = addCustomer.addNewCustomer("10003", "Melvin", "Gordon", "pass123", true, true, "MASTERCARD");
    ...
    public final void whenAddingCustomerThenPasswordIsEncrypted() {
        Customer customer = addCustomer.addNewCustomer("10004", "Stacey", "Abrams", "pass123", true, false, "PLATINUM");
    ...
    public final void whenAddingCustomerWithPlatinumThenLimitsMatch() {
        Customer customer = addCustomer.addNewCustomer("10005", "Micheal", "Paul", "pass123", true, false, "PLATINUM");
